...
public class DateIntervalFormat extends UFormat implements Cloneable {
     ...
     * getInstance(String skeleton, ULocale locale)
     *
     * <!-- From: android.icu.samples.text.dateintervalformat.DateIntervalFormatSample:dtitvfmtPreDefinedExample -->
     * <p>Example code:</p>
     *
     * <pre>
     ...
     * getInstance(String skeleton, ULocale locale, DateIntervalInfo dtitvinf)
     *
     * <!-- From: android.icu.samples.text.dateintervalformat.DateIntervalFormatSample:dtitvfmtCustomizedExample -->
     * <p>Example code:</p>
     *
     * <pre>
     * final Date date[] = {
